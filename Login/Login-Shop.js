...
const products = [
    ...
    },
    {
        ...
        price: "$35.00",
        image: "https://i0.wp.com/www.thebeautyjournalsxo.com/wp-content/uploads/2021/01/Photo_1607834403554-scaled.jpg?resize=960%2C1101&ssl=1"
    },
    {
        id: "serum_kiehls_ret",
    ...
    },
    {
        ...
        name: "Ultra Facial Cream with Squalane and skincare cream",
        category: "Moisturizer (Hydrating)",
        description: "Deeply hydrating, simple formula for all skincare types.",
        price: "$35.00",
    ...
    },
    {
        ...
        description: "Rich anti-aging moisturizer for deep hydration and nourishment.",
        price: "$100.00",
        image: "https://m.media-amazon.com/images/I/61EBcmK-lOL._UF1000,1000_QL80_.jpg"
    },
    {
        id: "spf_eltamd",
        name: "UV Clear Broad-Spectrum",
        category: "SPF",
    ...
    },
    {
        ...
        category: "Mask (Clay)",
        description: "Detoxifies and purifies pores, great for oily/combo skin.",
        price: "$25.00",
    ...
    },
    {
        ...
        category: "Eye Cream",
        description: "Rich, hydrating eye cream to nourish and de-puff the under-eye area.",
        price: "$35.00",
        image: "https://k-beautyskin.com/wp-content/uploads/2025/03/COSNORI_Avocado_Eye_Cream_All_Face_30ml_k-beauty_skin_India-2.webp"
    },
    {
        id: "lip_summerfridays",
        name: "Lip Butter Balm",
        category: "Lip Treatment",
        description: "Nourishing balm for instant hydration and a glossy shine.",
        price: "$24.00",
    ...
    },
    {
        ...
        category: "Body Care",
        description: "Intensely hydrating body lotion for dry or tight skin and long-lasting moisture.",
        price: "$40.00",
        image: "https://bimsbeautyltd.com/cdn/shop/files/IMG_0601.jpg?v=1728059170"
    }
];

/// =========================================================
// 1. GLOBAL VARIABLES AND HELPER FUNCTIONS (Consolidated)
// =========================================================

// Assuming 'products' array is defined elsewhere (as in your previous code)
// Example structure (use your actual array):
/*
const products = [
    { id: "serums-35", name: "Hydrating Serum", price: 35.00, price_display: "$35", image: "..." },
...
// The following functions rely on external/undefined variables (like searchInput, PRODUCTS, grid, sortBtn)
// and are left as-is, assuming their dependencies are defined elsewhere. They were not consolidated
// because their multiple definitions were identical and the core cart fix didn't depend on them.
...
// footer 
// Add this to your existing JavaScript file, within the DOMContentLoaded listener
document.addEventListener('DOMContentLoaded', () => {
...
//  responsive header 
// Add this function and event listener to your main JavaScript file:
...
function setupMobileMenu() {
    ...
    if (menuToggle && navLinks) {
        menuToggle.addEventListener('click', () => {
            ...
            // Toggle the 'expanded' class for CSS animation
...
// Call this function when the DOM is ready (e.g., inside your DOMContentLoaded listener)
document.addEventListener('DOMContentLoaded', () => {
